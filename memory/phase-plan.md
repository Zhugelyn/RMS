...
Status: **open** — `phase6-vk-docs` ✅; `phase6-vk-client` ✅; next=`phase6-vk-artifacts`.
...
- [ ] Посты: `text` + photo attachments; closed/Donut → soft skip. (mapper ✅ in client; artifacts wiring later)
...
- [x] `dotnet test` + compose зелёные (client slice; no artifacts yet).
