...
Status: **open** (scheduler ✅ → next impl = `phase4-miniapp-research`).
...
- [ ] Счедулер research на 14 дней ✅ (`phase4-scheduler`); настройки в Mini App и `/research` в боте ← `phase4-miniapp-research`.
