...
- Pack files 2026-08-20 (`phase8-pack-files`): salon/marketing MCP `files` + skill `files-store`; `FilesPackInjector` metadata inject; PackCatalog require `kb-retriever`+`files`; router/tasks empty; domain isolation tests. Hardening → `phase8-hardening`.
